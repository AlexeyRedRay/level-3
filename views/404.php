    ...
    <nav class="navbar navbar-default">
        <div class="container">
            <div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
                <div class="logo"><a href="http://lvl3.loc/" class="navbar-brand"><span class="sh">Ш</span><span class="plus">++</span></a></div>
            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <form class="navbar-form navbar-right"  name="searchBook" action="search-book" method="get" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="loader"><img src="http://lvl3.loc/assets/img/loading.gif"></div>
...
<section id="main" class="main-wrapper">
       ...
       <br><h1 style="text-align: center">404 Not Found</h1>
